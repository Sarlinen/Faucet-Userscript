...
(function() {
    ...
    if($('#fp_email')) {
    $("#fp_email").val("Donation@remi.pe.kr");////EDIT WITH YOUR FAUCETPAY EMAIL ADDRESS HERE/////
    address = true;
    }
    setTimeout(function() {
    ...
    setTimeout(function() {
    if (window.location.href.includes("https://jmcrypto.eu.org/?ref=Donation@remi.pe.kr")) {
