...
(function() {
    ...
    setTimeout(function() {
    if($('.main__input')) {
    $('.main__input').val("DMD3she4DjvAJRSynCh8gjw7feKZBMWBDK");////EDIT YOUR ADDRESS HERE/////
    address = true;
    } }, random(3000,5000));
    setTimeout(function() {
    ...
    setTimeout(function(){
    var url = "https:?r=DMD3she4DjvAJRSynCh8gjw7feKZBMWBDK"
    ...
    window.location.replace("https://digitask.ru/?r=DMD3she4DjvAJRSynCh8gjw7feKZBMWBDK");
    }
